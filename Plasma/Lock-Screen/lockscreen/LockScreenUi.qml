...
Item {
    ...
    MouseArea {
        ...
        // }
	// Replaced above with the 'Column' type below to be free to customize entire clock and dat
	...
	Column {
		...
		//Currently, the Clock's position is calculated based on where the Password box is 
		//    (y: (mainBlock.userList.y + mainStack.y)/2 ...).

		// --- NEW POSITIONING ---
                anchors.top: parent.top
                anchors.topMargin: parent.height * 0.15 // Places it 15% down from the top
		// -----------------------
		...
		color: "#FFFFFF"
		font.family: "Adwaita Sans"   // Your custom font
		font.weight: Font.Bold       // Bold weight
		font.pixelSize: 200           // Adjust size as needed
		anchors.horizontalCenter: parent.horizontalCenter
		}
		...
		color: "#FFFFFF"
		font.family: "Adwaita Sans"   // Your custom font
		font.weight: Font.Regular        // Bold weight
		font.pixelSize: 24            // Adjust size as needed
		anchors.horizontalCenter: parent.horizontalCenter
		}

		// Update logic (ticks every second)
		Timer {
		interval: 1000
		running: true
		repeat: true
		...
		// --- ADD THESE LINES to space Password and media control lower below clock and date ---
                verticalCenter: parent.verticalCenter 
                verticalCenterOffset: 300 // Positive number moves it DOWN. Increase to 200 for more space.
                // -----------------------
            }
