...
// --- START OF NEW CODE ---
   ...
   //             // 1. The main background color (White with low opacity)
   //             color: "#FFFFFF" 
   //             opacity: 0.15 
   //             radius: 8  // Your rounded corners
//
  //              border.width: 0  // to DISABLE the highlight completely
   //             
    //           implicitHeight: 25 // 40 is a standard comfortable height

                // OPTIONAL: If you want a White Border instead of Purple,
                // remove "border.width: 0" above and uncomment these two lines:
